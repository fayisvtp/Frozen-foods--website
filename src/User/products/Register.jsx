    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        if (status === "success") {
          ...
          // Return early to prevent further execution after successful registration
          return navigate("/userlogin");
        } 
      } catch (error) {
   
        console.log(error)
        // Display error toast for existing user
        toast.error("User already registered");
        
        // Return early to prevent further execution after encountering an error
        return navigate("/userlogin")
      }
    },
  });
